    ...
    <div className="contatos">
      ...
      <div className='textForm'>
        <div className="txtContatos">
          ...
          <div>
            <MdWhatsapp size={39}/><span> Hey! Estamos no WhatsApp!</span>
          </div>
        </div>
        <div className="form">
          ...
          <input type="email" name="email" id="" placeholder='email@email.com.br'/>
          <label htmlFor="telefone">Telefone</label>
          <input type="number" name="telefone" id="" placeholder='XX 00000-0000'/>
